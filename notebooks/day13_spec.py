...
print('3조까지 붙는 구성이 됐다')"""),
    ...
    Task(1, "**조별 서버**를 설계한다. 코드는 안 쓴다. 다섯 칸만 채운다.\n"
...
SPEC = ("MCP 서버 만들기 · 앱에 붙이기",
        "노트북 안에 있던 서버를 파일로 떼어 내고, 띄우고, 다른 앱이 붙게 한다", CELLS, MODES)
